...
namespace ImageRotationCSharp
{
    internal class Program
    {
        ...
        public void Launch()
        {
            ...
            OpenCL.Net.Context context = OpenCL.Net.Cl.CreateContext(null, 1, new[] { device }, ContextNotify, IntPtr.Zero, out error);    
            ...
            OpenCL.Net.Kernel kernel = OpenCL.Net.Cl.CreateKernel(program, "image_rotate", out error);
